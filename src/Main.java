	...
	public static void makeMove(String moves)
    {
    	...
    	//{
    		...
    		else if (!turnC)
    		{
				...
				// possibleMovesL());
				String posMoves = randomMove(possibleMovesL());
    	...
    	/*else
    	{
    		//chessBoard[1][Character.getNumericValue(moves.charAt(0))] = " ";
    		//chessBoard[0][Character.getNumericValue(moves.charAt(1))] = String.valueOf(moves.charAt(3));
        ...
        for (int i=0; i<64; i++) 
        {
            switch (chessBoard[i/8][i%8]) // 55 / 8 ~ 6 || 55 % 8 = 7
            {
                ...
                case "b": list += possible_b(i);
                    break;
              /*  case "q": list += possible_q(i);
                    break;
                case "a": list += possible_a(i);
                    break;*/
            }
        }
        return list + "\n";
