...
//            {
//                case "P": list += movement.possibleP(i);//possibleP(i);
//                    break;
//                case "R": list += movement.possibleR(i);
//                    break;
//                case "K": list += movement.possibleK(i);
//                    break;
//                case "B": list += movement.possibleB(i);
//                    break;
//                case "Q": list += movement.possibleQ(i);
//                    break;
//                case "A": list += movement.possibleA(i);
//                    break;
//            }
//        }
//        return list + "\n";
...
//            switch (chessBoard[i/8][i%8]) // 55 / 8 ~ 6 || 55 % 8 = 7
//            {
//                case "p": list += movement.possible_p(i);//possibleP(i);
//                    break;
//                case "r": list += movement.possible_r(i);
//                    break;
//                case "k": list += movement.possible_k(i);
//                    break;
//                case "b": list += movement.possible_b(i);
//                    break;
//            
//            }
//        }
...
//    	for (int i=0;i<8;i++) 
//	  	{
//            System.out.println(Arrays.toString(Main.chessBoard[i]));
//        }
//		
//		System.out.println("-----------------------");
//		for (int i=0;i<8;i++) 
